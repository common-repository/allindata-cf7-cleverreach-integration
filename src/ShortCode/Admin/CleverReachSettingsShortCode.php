...
/**
 * Class CleverReachSettingsShortCode
 * @package AllInData\CF7CRIntegration\ShortCode\Admin
 */
class CleverReachSettingsShortCode extends AbstractAdminShortCode implements PluginShortCodeInterface
{
    const SHORTCODE_NAME = 'aid_c7cr_admin_cleverreach_settings';
    const TEMPLATE_NAME = 'contactform7/cleverreach-settings';
}